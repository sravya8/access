...
public class TestPerDBConfiguration extends AbstractTestWithStaticLocalFS {
  ...
  public void testMultiPerDBwithErrors() throws Exception {
    ...
    String[] policyFileContents = {
        ...
        Users.user1.name() + " = user_group1",
        Users.user2.name() + " = user_group2",
        Users.user3.name() + " = user_group3",
        Users.user4.name() + " = user_group4",
        "[databases]",
        "db2 = " + db2PolicyFile.getPath(),
    ...
    connection = context.createConnection(Users.user3.name(), "password");
    statement = context.createStatement(connection);
    ...
    connection = context.createConnection(Users.user4.name(), "password");
    statement = context.createStatement(connection);
    statement.execute("USE db4");
    // test user1 can execute query on tbl1
